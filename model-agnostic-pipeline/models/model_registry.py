...
# GAN models moved to organized location
sys.path.append(os.path.join(os.path.dirname(__file__), '..', 'gan_models', 'models'))
from gan_simple import SimpleGANModel
from gan_compact import CompactGANModel
...
class ModelRegistry:
    ...
    def _register_default_models(self):
        ...
        self.register("gan_simple", SimpleGANModel)
        self.register("gan_compact", CompactGANModel)
