...
/**
 * Enhanced Classifier Verifier
 * 
 * Step 1 in the sequential chain.
 * Input Shape: [8]
 * Output Shape: [5]
 * 
...
contract EnhancedClassifierVerifier {
    ...
    function getContractInfo() external view returns (
        ...
        return (underlyingVerifier, INPUT_SIZE, OUTPUT_SIZE, "classifier");
    }
}